...
function hitungTarif() {
    ...
    "2A": [3950, 4850, 6250, 8350],
    "2B": [4300, 5200, 6650, 8750],
    "2C": [4950, 6100, 7750, 10150],
    "2D": [7750, 10200, 15950, 26150],
    "2E": [7900, 11750, 18250, 29650],

    "3A": [8650, 10000, 12150, 15450],
    ...
    hasilDiv.innerHTML = `
        <div class="result-box">
            ...
            <p>
                ...
                Materai: ${formatRupiah(biayaMaterai)}
            </p>
        </div>
    `;
}
